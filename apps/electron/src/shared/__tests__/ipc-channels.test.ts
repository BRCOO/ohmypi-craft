...
// Wire-format snapshot. Keep this sorted with RPC_CHANNELS when a channel changes.
const EXPECTED_CHANNELS: string[] = [
  ...
  'oauth:revoke',
  'oauth:start',
  'omp:clearCommandPath',
  'omp:createResource',
  'omp:getDiagnosticsSummary',
  'omp:getFeatureCenterState',
  'omp:getLoginProviders',
  'omp:getResourceSnapshot',
  'omp:getStatus',
  'omp:loginProvider',
  'omp:openFeatureCenterPath',
  'omp:refreshResources',
  'omp:removeResource',
  'omp:saveFeatureCenterConfig',
  'omp:setCommandPath',
  'omp:setResourceEnabled',
  'omp:testMcpResource',
  'omp:updateResource',
