 ...
 * Includes only relevant items for the Oh My Pi app.
 *
 ...
 *
 * On Windows/Linux: Menu is hidden - all functionality is in the Oh My Pi logo menu.
...
export async function rebuildMenu(): Promise<void> {
  ...
  // Users access menu via the Oh My Pi logo dropdown in the app
  if (!isMac) {
      ...
      submenu: [
        {
          ...
          click: () => shell.openExternal('https://github.com/BRCOO/ohmypi-craft/tree/main/docs')
        },
        {
