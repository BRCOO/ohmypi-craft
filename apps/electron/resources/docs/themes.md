...
This guide explains how to customize the visual theme of Oh My Pi.

## Overview

Oh My Pi uses a 6-color theme system with support for both app-level defaults and per-workspace overrides.
