...
echo "=== Building Oh My Pi AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Oh-My-Pi-x86_64.AppImage or Oh-My-Pi-aarch64.AppImage
BUILT_APPIMAGE_NAME="Oh-My-Pi-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Oh-My-Pi-x64.AppImage, Oh-My-Pi-arm64.AppImage
APPIMAGE_NAME="Oh-My-Pi-${ARCH}.AppImage"
